          ...
          <div className="row row-cols-1 row-cols-md-3 g-4">
            <div className="col">
              <div className="card px-3 py-4 shadow-sm">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQihxIaFkTD-cGMcyBkF5fXPHed6iTkxj_HtA&usqp=CAU"
                  alt
            ...
            <div className="col">
              <div className="card px-3 py-4 shadow-sm">
                <img src="..." className="card-img-top" alt="..." />
                <div className="card-body">
                  <h5 className="card-title">Andhra Cuisinne</h5>
                  <p className="card-text">
                    This is a longer card with supporting text below as a
            ...
            <div className="col">
              <div className="card px-3 py-4 shadow-sm">
                <img src="..." className="card-img-top imgs" alt="..." />
                <div className="card-body">
